...
## Premières approches
### L’enquête GTDID : usages et conditions d’appropriation de la science ouverte

L’enquête conduite par le **Groupe de travail sur les disparités et inégalités doctorales (GTDID)** constitue un dispositif transversal à plusieurs axes de CREONS. Tandis que l’axe 1 mobilise principalement cette enquête pour analyser les conditions matérielles, institutionnelles et académiques de réalisation du doctorat, l’axe 2 s’intéresse plus spécifiquement aux connaissances, aux usages et aux conditions d’appropriation des outils et des pratiques de la science ouverte.
...
8. le rôle de l’encadrement doctoral, des laboratoires et des établissements dans la diffusion de ces pratiques.
...
Une première phase de l’enquête a été réalisée auprès de doctorant.es en sciences sociales et environnementales de l’Université Cheikh Anta Diop de Dakar. Elle a permis de constituer le premier volet du jeu de données **DWISE — Doctoral Work and Inequalities in Scientific Ecosystems** [@faye2026].
...
Cette recherche permet d’examiner de manière empirique une tension centrale de CREONS. La science ouverte peut réduire certaines barrières en facilitant l’accès aux connaissances, la diffusion des travaux et la réutilisation des ressources scientifiques. Mais elle peut également reproduire ou accentuer les inégalités lorsque son adoption suppose des équipements, des compétences et des infrastructures dont tous les doctorant.es ne disposent pas.
...
**Articulation avec le PSF CREONS**

Les résultats de l’enquête ont également vocation à orienter les actions de formation et d’accompagnement du **PSF CREONS**. L’identification des pratiques existantes, des obstacles et des besoins permet d’adapter les formations du protocole T2VA aux conditions concrètes rencontrées dans les différents environnements universitaires.

L’enquête et le dispositif de formation constituent ainsi deux démarches complémentaires : la première documente les conditions d’appropriation de la science ouverte, tandis que le second expérimente des formes d’accompagnement susceptibles de les renforcer.
